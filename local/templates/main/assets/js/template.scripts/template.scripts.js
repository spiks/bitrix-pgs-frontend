...
;// CONCATENATED MODULE: ./src/template/js/GlobalModuleName.js



var GlobalModuleName = /*#__PURE__*/function () {
  function GlobalModuleName() {
    (0,classCallCheck/* default */.Z)(this, GlobalModuleName);
  }

  (0,createClass/* default */.Z)(GlobalModuleName, null, [{
    key: "test",
    value: function test() {
